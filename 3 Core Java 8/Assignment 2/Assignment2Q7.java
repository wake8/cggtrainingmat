 ...
 * Candy item is sold in dollar currency, Cookie in Euro currency & Ice Cream in Rupees currency. 
 * The sub classes are supposed to override these methods. 
 * When we run the application, 
 * it should ask us our role i.e. owner or customer. 
 * If role is owner, we should be able to add dessert items in our storage. 
 * If role is customer, then we should be able to place an order. The currency conversion rates are:
